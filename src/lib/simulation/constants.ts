...
export const SIMULATION_TIMEFRAME_MAP: Record<string, string> = {
  '1d': '5m',   // 1일봉 → 5분봉 (288배 세밀)
  '4h': '1m',   // 4시간봉 → 1분봉 (240배 세밀)
  '2h': '1m',   // 2시간봉 → 1분봉 (120배 세밀)
  '1h': '1m',   // 1시간봉 → 1분봉 (60배 세밀)
  '30m': '1m',  // 30분봉 → 1분봉 (30배 세밀)
  '10m': '1m',  // 10분봉 → 1분봉 (10배 세밀)
  '5m': '1m',   // 5분봉 → 1분봉 (5배 세밀)
  '1m': '1m',   // 1분봉 → 1분봉 (동일)
}
